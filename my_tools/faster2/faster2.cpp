...
const char* VER = "0.25";
const char* DATE = "2013-09-03";


inline void usage() {
    std::cout << "Version: faster2 " << VER << " " << DATE << "\n";
    std::cout << "Copyright: (c) 2012 Jaroslaw Zola <jaroslaw.zola@gmail.com>\n";
    ...
    std::cout << "   sample <size> [seed]                    create sample without replacement\n";
    std::cout << "   select <name> [name1 name2 ...]         select by name\n";
} // usage
