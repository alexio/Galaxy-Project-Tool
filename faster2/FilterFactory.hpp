...
public:
	...
	filters_list = { "filter", "names", "print", "report", "sample", "select", "anonymize" };
    }; // FilterFactory
	...
	if (name == "anonymize") return std::shared_ptr<Filter>(new AnonymizeFilter(args));
