...
_magic_number = 6
_modified_time = 1396935303.12557
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x843dfd0', context._clean_inheritance_tokens(), templateuri=u'/root/tool_menu.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x843dfd0')] = ns

    # SOURCE LINE 4
    ns = runtime.TemplateNamespace('__anon_0x8447390', context._clean_inheritance_tokens(), templateuri=u'/history/history_panel.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x8447390')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x843dfd0')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0x8447390')._populate(_import_ns, [u'current_history_panel'])
